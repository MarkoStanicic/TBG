<?php
/**
 * Template Name: Shopping Page Template
 *
 */
get_header(); ?>
...
<main role="main" aria-label="Content">
    ...
    <section class="category">
        ...
        $categories = get_the_category(6);
        $category_id = $categories[6]->cat_name;
...
//            'cat_name'  => array( 5, 21, 22, 23 ),
        ...
        <div id="pages-slider">
            <div class="flexslider">
                <ul class="col-md-12 slides">
                    ...
                    //== set category id
                    $cat_id_slider = the_field('slider_shopping_section');
                    //== set slide number
                    $slide_num = the_field('number_of_slides_in_shopping_section');
                    //== arguments
                    $args = array(
        ...
        <div class="container">
            <div class="col-sm-9">
	            <?php get_template_part('loop', 'shopping'); ?>
            </div>
            <div class="col-sm-3">
	            <?php get_sidebar(); ?>
            </div>
