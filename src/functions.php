...
'add_new_item' => __('Add New Events', 'html5blank'),
'edit' => __('Edit', 'html5blank'),
'edit_item' => __('Edit Events', 'html5blank'),
'new_item' => __('New Events', 'html5blank'),
'view' => __('View Events', 'html5blank'),
'view_item' => __('View Events', 'html5blank'),
...
function vb_filter_posts() {
    if( !isset( $_POST['nonce'] ) || !wp_verify_nonce( $_POST['nonce'], 'thebelgradeguide' ) )
